...
Or with the command line using:
    ...
    wget https://hydra.iohk.io/job/Cardano/cardano-node/cardano-deployment/latest-finished/download/1/shelley_testnet-shelley-genesis.json -O shelley_testnet-genesis.json
